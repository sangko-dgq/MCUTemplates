...
#define GT20L16S1Y_GPIO_Port GPIOA
#define GT20L16S1Y_Pin       GPIO_PIN_2

#define	GT20L16S1YSetCS()		HAL_GPIO_WritePin(GT20L16S1Y_GPIO_Port, GT20L16S1Y_Pin, GPIO_PIN_SET);
#define	GT20L16S1YClrCS()		HAL_GPIO_WritePin(GT20L16S1Y_GPIO_Port, GT20L16S1Y_Pin, GPIO_PIN_RESET);
