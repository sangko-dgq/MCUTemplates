...
/* ÊäÈë25Mhz¾§Õñ */
/*
HSE????4~32MHz?????????????HSE crystal?HSE bypass????
??HSE crystal???OSC_IN?OSC_OUT?????
?HSE bypass????OSC_IN?????????GPIO???
?????HSE???????????HSERDY bit????HSE??????
???????????????HSE?CSS????????HSE??????HSI?
*/
...
//100MhzÍÆ¼ö
//Íâ²¿¾§ÕñÎª25MµÄÊ±ºò,ÍÆ¼öÖµ:plln=400,pllm=25,pllp=4,pllq=8.
//µÃµ½:Fvco=25*(400/25)=400Mhz
//     Fsys=40/4=100Mhz
//     Fusb=400/8=50Mhz£¨Ê¹ÓÃUSBÊ±£¬ÐèÉèÖÃplln=384£¬¼´¿ÉµÃµ½48MhzÆµÂÊ£©

//168MhzÍÆ¼ö
//Íâ²¿¾§ÕñÎª25MµÄÊ±ºò,ÍÆ¼öÖµ:plln=336,pllm=25,pllp=2,pllq=8.
//µÃµ½:Fvco=25*(336/25)=336Mhz
//     Fsys=336/2=168Mhz
//     Fusb=336/8=42Mhz£¨Ê¹ÓÃUSBÊ±£¬ÐèÉèÖÃplln=384£¬¼´¿ÉµÃµ½48MhzÆµÂÊ£©

//180MhzÍÆ¼ö
//Íâ²¿¾§ÕñÎª25MµÄÊ±ºò,ÍÆ¼öÖµ:plln=360,pllm=25,pllp=2,pllq=8.
//µÃµ½:Fvco=25*(380/25)=360Mhz
//     Fsys=360/2=180Mhz
//     Fusb=360/8=45Mhz£¨Ê¹ÓÃUSBÊ±£¬ÐèÉèÖÃplln=384£¬¼´¿ÉµÃµ½48MhzÆµÂÊ£©

//ÐÞ¸ÄÆµÂÊ PLL=PLL_M(25Mhz)*N(400)/(M*P(4))=25*400/(25*4)=100
/************************* PLL Parameters *************************************/
...
#define PLL_M 25 //PLL=PLL_M(25Mhz)*N(400)/(M*P(4))=25*400/(25*4)=100
