...
/*最大水平和垂直分辨率*/
#define LV_HOR_RES_MAX          (135)  //水平
#define LV_VER_RES_MAX          (240)  //垂直
...
/*开辟多少内存给lvgl运作*/  /*16 *2 *1024*/
#define LV_DISP_ROT_MAX_BUF  (32U * 1024U)
...
#define LV_USE_FILESYSTEM       0 //是否使用文件系统
...
#define LV_USE_USER_DATA        1 //Userdata

/*1: Show CPU usage and FPS count in the right bottom corner*/
/*：在右下角显示CPU使用率和FPS计数*/
#define LV_USE_PERF_MONITOR     1  //#TODO FPS ON/OFF

/*1: Use the functions and types from the older API if possible */
#define LV_USE_API_EXTENSION_V6  1
#define LV_USE_API_EXTENSION_V7  1  //兼容老版本
...
#define LV_IMG_CF_ALPHA         1   //图片透明通道
...
/* Demonstrate special features */ /*展示特殊功能*/
...
#define LV_USE_THEME_EMPTY       0   //使用空主题
