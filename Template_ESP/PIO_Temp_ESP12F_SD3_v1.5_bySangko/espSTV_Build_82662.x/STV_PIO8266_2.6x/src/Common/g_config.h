...
//其余状态标志位
extern uint8_t is_Wifi_ON;         //wifi状态标志位  1：打开    0：关闭
extern uint8_t UpdateWeater_en; //更新时间标志位
extern int prevTime;            //滚动显示更新标志位
extern int is_DHT_Use;        //DHT传感器使用标志位
...
/*
             COLORS DEFINE 16bits 0x______
*/
#define SublineYellow 0xFFBA52
#define FullBlack 0x000000

#define Black70p 0x4a4a4a //70%Black
#define Black80p 0x333333 //80%Black

//#define isInvertColor 0  /*是否反转所有显示颜色：1反转，0正常*/
