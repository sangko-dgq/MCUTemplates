...
/*绘制进度条函数，进度采用延时增宽矩形实现（每一次增加矩形的width，即loadingBarValue）*/
byte loadingBarValue = 6; /*LoadingBar的进度数值(进度矩形宽度)，0~194*/
void LcdBuild_LoadingBar(byte delayTime)
{
  ...
  clk.fillRoundRect(3, 3, loadingBarValue, 10, 5, 0xFFFF); //实心圆角矩形
