...
//========================================================================
// 函数: void I2C_WriteAbyte(uint8_t dat)
// 描述: I2C发送一个字节数据函数.
// 参数: 发送的数据.
// 返回: none.
// 版本: V1.0, 2020-09-15
...
//========================================================================
// 函数: void	SI2C_WriteNbyte(uint8_t addr, uint8_t *p, uint8_t number)
// 描述: I2C写入数据函数.
...
//========================================================================
// 函数: void	SI2C_ReadNbyte(uint8_t addr, uint8_t *p, uint8_t number)
// 描述: I2C读取数据函数.
