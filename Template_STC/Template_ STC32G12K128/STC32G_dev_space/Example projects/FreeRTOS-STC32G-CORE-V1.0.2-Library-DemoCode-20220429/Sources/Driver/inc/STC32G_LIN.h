...
typedef struct
{
	uint8_t	LIN_Enable;			//LIN功能使能  	ENABLE,DISABLE
	uint16_t LIN_Baudrate;		//LIN波特率
	uint8_t	LIN_IE;				//LIN中断使能  	LIN_LIDE/LIN_RDYE/LIN_ERRE/LIN_ABORTE/LIN_ALLIE,DISABLE
	uint8_t	LIN_HeadDelay;		//帧头延时计数  	0~(65535*1000)/MAIN_Fosc
	uint8_t	LIN_HeadPrescaler;	//帧头延时分频  	0~63
} LIN_InitTypeDef;
