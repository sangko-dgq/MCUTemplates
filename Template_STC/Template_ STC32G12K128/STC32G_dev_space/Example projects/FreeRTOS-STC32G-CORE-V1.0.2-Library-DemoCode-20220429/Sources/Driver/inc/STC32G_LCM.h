...
typedef struct
{
	uint8_t	LCM_Enable;				//LCM接口使能  	ENABLE,DISABLE
	uint8_t	LCM_Mode;				//LCM接口模式  	MODE_I8080,MODE_M6800
	uint8_t	LCM_Bit_Wide;			//LCM数据宽度  	BIT_WIDE_8,BIT_WIDE_16
	uint8_t	LCM_Setup_Time;			//LCM通信数据建立时间  	0~7
	uint8_t	LCM_Hold_Time;			//LCM通信数据保持时间  	0~3
} LCM_InitTypeDef;
