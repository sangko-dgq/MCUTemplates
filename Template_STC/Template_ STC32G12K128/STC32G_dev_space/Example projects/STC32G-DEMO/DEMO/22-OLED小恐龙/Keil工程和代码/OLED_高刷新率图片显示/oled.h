...
sbit OLED_SCL=P2^1;			// OLED SCLK 引脚
sbit OLED_SDIN=P2^0;		// OLED SDA	 引脚
...
void BMPmove(unsigned char BMPx1,unsigned char BMPy1,unsigned char BMPx2,unsigned char BMPy2,unsigned char *BMPn,unsigned char BMPfx,unsigned int sudu);
